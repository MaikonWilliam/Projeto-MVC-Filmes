...
namespace MVCFilmes.Controllers
{
    public class FilmesAController : Controller
    {
        ...
        {
            //Query Genero
            IQueryable<string> generos = from g in _context.Filmes
                                         orderby g.Genero
                                         select g.Genero;
            //Query Filme
        ...
        public async Task<IActionResult> Create([Bind("ID,Titulo,DataLancamento,Genero,Preco,Avaliacao")] Filmes filmes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Titulo,DataLancamento,Genero,Preco,Avaliacao")] Filmes filmes)
        {
            if (id != filmes.ID)
            {
                return NotFound();
